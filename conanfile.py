...
class BehavioralPatternsConan(ConanFile):
    ...
    url = "https://github.com/AliIbrahim996/BehavioralPatterns"
    description = ""
    ...
    def package_info(self):
        self.cpp_info.libs = ["BehavioralPatterns"]
